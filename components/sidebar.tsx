...
export const Sidebar = () => {
    return (
        ...
        <div className="bg-secondary shadow-lg p-6">
            ...
            <div className="mb-8">
                <h3 className="uppercase text-md font-semibold mb-2 sticky bg-secondary py-2 top-0 text-left">Місяць тому</h3>
                <ul className="space-y-2 list-none  pl-0">
                    <li>
            ...
            <div>
                <h3 className="uppercase text-md font-semibold mb-2 sticky bg-secondary py-2 top-0 text-left">Рік тому</h3>
                <ul className="space-y-2 list-none  pl-0">
                    <li>
