                ...
                {getVisibleSlides().map((slide, index) => (
                    <div key={index} className="slide">
                        <Image
                            ...
                            priority={index === 0}
                        />
                        <div className="lg:hidden relative z-20 text-white text-xl pl-6 mt-10">Ласкаво просимо в Світ
                            Бібліі
                        </div>
                        ...
                        <div className="hidden lg:block absolute rounded-3xl z-20 w-5/6 max-w-full text-l text-center bottom-5 bg-white left-5 p-2 text-black font-bold uppercase">
                            {slide.prev}
                            <span className="inline-block w-5 ml-3.5 relative top-0.5">{slide.ico}</span>
                        </div>
