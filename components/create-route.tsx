...
export const CreateRoute = () => {
    return (
        <div className="bg-white shadow-lg rounded-lg p-8 max-w-md w-full m-auto">
            <h2 className="text-3xl font-semibold text-gray-800 mb-4 text-center">Давайте разом створимо
