  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-card-soft overflow-hidden flex h-auto">
      ...
      <div className="p-4 flex flex-col justify-between flex-grow w-2/3">
        ...
        <div className="mb-4">
          <h3 className="text-lg text-left font-semibold text-gray-900 border-b border-gray-300 dark:text-white line-clamp-2">
            {title}
          </h3>
          {author && (
            <p className="text-lg text-gray-600 dark:text-gray-400 text-sm line-clamp-1">
              {author}
            </p>
          )}
        </div>
        ...
        <div className="absolute inset-y-4 right-4 w-[calc(100%-1rem)] h-[calc(100%-2rem)] bg-primary rounded-lg shadow-lg flex flex-col items-center justify-center text-white p-2 text-center">
