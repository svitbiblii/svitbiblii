...
const libraries: LibrarySeed[] = [
    ...
    },
    {
        ...
        content: "Переклад Біблії Івана Огієнка — це найбільш поширений і вживаний переклад Біблії українською мовою.",
        category: "Patristics"
    },
    {
        title: "Поліанна",
        ...
        link: "/library/porter",
        content: "Це захоплива розповідь про 12ти річну чарівну дівчинку, з появою якої змінилося життя в спокійному провінційному містечку. Це маленьке дівчисько завдяки своїй доброті, безпосередності, життєрадісності та енергійності зуміла розтопити черстві серця людей, приречених на сіре та безпросвітне існування.",
    ...
    },
    {
        ...
        content: "The World English Bible (WEB) is an English translation of the Bible freely shared online. The translation work began in 1994 and was deemed complete in 2020. Created by Michael Paul Johnson with help from volunteers,[1][6] the WEB is an updated revision of the American Standard Version from 1901.",
        category: "Theology"
    }
];
