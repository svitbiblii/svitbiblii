...
const Book: React.FC<BookProps> = ({ book, variant }) => {
    ...
    const commonCardClasses = 'bg-white dark:bg-gray-800 rounded-lg shadow-card-soft overflow-hidden flex';
  ...
  if (variant === 'large') {
    ...
    const displayedContent = showExpandButton && !isContentExpanded
    ...
    return (
      <div className={`${commonCardClasses} w-48 md:w-56 lg:w-64 transform transition duration-300 hover:scale-105 flex-col`}>
