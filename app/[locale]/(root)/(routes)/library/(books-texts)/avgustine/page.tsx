     ...
     return (
        <div className="h-min-full flex">
         ...
         <div className="relative h-full w-full px-4 pt-2 block">
          ...
          <p>
          <span id="imp" onClick={() => {setNewId('25')}}>Одначе як я волатиму до Бога мого, Бога й Господа мого?</span> Бо ж, волаючи до Нього, я мов би прохатиму, щоб Він увійшов у мене. І яке ж місце є в мені, в яке міг би увійти в мене Бог мій? Куди ж міг би увійти Бог у мене, Бог, що створив небо і землю? Чи ж можливо, Господи Боже мій, щоб я мав щось, що вмістило б Тебе? Чи обіймають Тебе «небо і земля», що Ти їх створив, і в лоні яких Ти створив і мене? Чи, може, з того, що існує, виходить, що все суще охоплює Тебе? Та якщо і я існую, то чому ж благаю Тебе, щоб Ти вступив в мене, у мене, що не існував би, коли б Тебе не було в мені? Бо нема мене ще в підземеллі, а Ти й там є, бо «хоча б я зійшов і до Пекла, той там би знайшов Тебе».
          </p>
