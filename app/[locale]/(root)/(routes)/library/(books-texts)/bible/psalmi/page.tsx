      ...
      <div className="relative h-full w-full px-4 pt-2 block">
        ...
        <div className="w-full">
          ...
          <section id="section2" className="mx-auto w-4/5 md:w-3/5 lg:w-1/2 mb-2 px-2 border border-gray-300 rounded-md">
            ...
            <p className={isHighlighted ? 'text-blue-400 ': ''}>1 Ти мене випробував, Господи, і знаєш.</p>
            <p className={isHighlighted ? 'text-blue-400 ': ''}>2 Знаєш мене, коли сиджу і встаю я. Думки мої здаля розумієш.</p>
            <p className={isHighlighted ? 'text-blue-400 ': ''}>3 Чи ходжу я, чи спочиваю, ти добре бачиш; тобі відомі всі мої дороги.</p>
            <p className={isHighlighted ? 'text-blue-400 ': ''}>4 Бо ще нема й слова на язиці у мене, а ти, Господи, вже все знаєш.</p>
            <p className={isHighlighted ? 'text-blue-400 ': ''}>5 Ти ззаду й спереду мене оточуєш, кладеш на мене твою руку.</p>
            <p className={isHighlighted ? 'text-blue-400 ': ''}>6 Що за предивне знання! Для мене занадто високе, недосяжне воно!</p>
            <p className={isHighlighted ? 'text-blue-400 ': ''}>7 Куди мені піти від духу твого? Куди мені втекти від обличчя твого?</p>
            <p className={isHighlighted ? 'text-blue-400 ': ''}>8 Зійшов би я на небо – ти там єси, ліг би я у Шеолі – і там ти.</p>
            <p className={isHighlighted ? 'text-blue-400 ': ''}>9 Взяв би крила зірниці, осівся б на край моря, –</p>
            <p className={isHighlighted ? 'text-blue-400 ': ''}>10 і там рука твоя мене б водила, і твоя десниця мене б тримала.</p>
