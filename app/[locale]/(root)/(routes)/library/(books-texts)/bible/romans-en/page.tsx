...
export default function RomansEnPage() {
	...
	useEffect(() => {
		...
		const shouldScrollToSection =
			hash.includes('#romansEn-11-32') && hash.includes('scroll=true');
		...
		<div className="h-min-full flex">
			<div className="relative h-full w-full px-4 pt-2 block">
				<div className="w-full">
					<h2 className="pt-0">
						Epistle of Paul to the Romans (trans. New King James Version)
					</h2>
					<section
						id="section1"
					...
					>
						...
						<p>
							3. “Lord, they have murdered Your prophets and torn down Your altars,
						...
						<p>
							...
							that they should not see and ears that they should not hear, to this
							very day.”
						</p>
						<p>
						...
						<p>
							10. Let their eyes be darkened, so that they do not see, and bow down
							their back always.”
						</p>
						<p>
						...
						<p>
							12. Now if their fall is riches for the world, and their failure riches
						...
						<p>
							15. For if their being cast away is the reconciling of the world, what
						...
						<p>
							30. For as you were once disobedient to God, yet now have obtained mercy
					...
					>
						...
						<p>
							3. For I say, through the grace given to me, to everyone among you not
						...
						<p>
							8. he who exhorts, in exhortation; he who gives, with liberality; he who
						...
						<p>
							12. rejoicing in hope, patient in tribulation, continuing steadfastly in
							prayer;
						</p>
