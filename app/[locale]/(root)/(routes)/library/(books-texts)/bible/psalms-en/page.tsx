...
export default function PsalmsENPage() {
	...
	useEffect(() => {
		...
		const shouldScrollAndHighlight =
			hash.includes('#psalomEn138') && hash.includes('scroll=true');
			...
			<div className="relative h-full w-full px-4 pt-2 block">
				<div className="w-full">
					...
					>
						...
						<p>
							5 Yes, they shall sing of the ways of the Lord, for great is the glory
							of the Lord.
						</p>
						<p>
							6 Though the Lord is on high, yet He regards the lowly; but the proud He
							knows from afar.
						</p>
						<p>
							7 Though I walk in the midst of trouble, You will revive me; You will
							stretch out Your hand against the wrath of my enemies, and Your right
							hand will save me.
						</p>
						<p>
							8 The Lord will perfect that which concerns me; Your mercy, O Lord,
					...
					<section
						...
						className="mx-auto w-4/5 md:w-3/5 lg:w-1/2 mb-2 px-2 border border-gray-300 rounded-md"
					>
						<h2 id="psalomEn138" ref={psalomEn138Ref}>
							Psalm 138
						</h2>
						<p>
							1{' '}
						...
						<p>
							2{' '}
							<span className={isHighlighted ? 'text-primary ' : ''}>
								You know my sitting down and my rising up You understand my thou;ght
								afar off.
							</span>
						</p>
						<p>
							3{' '}
							<span className={isHighlighted ? 'text-primary ' : ''}>
								You comprehend my path and my lying down,and are acquainted with all
								my ways.
							</span>
						</p>
						<p>
							4{' '}
							<span className={isHighlighted ? 'text-primary ' : ''}>
								For there is not a word on my tongue, butbehold, O Lord, You kno w
								it altogether.
							</span>
						</p>
						<p>
							5{' '}
							<span className={isHighlighted ? 'text-primary ' : ''}>
								You have hedged me behind and before, andlaid Your hand upon
								me.{' '}
							</span>
						</p>
						<p>
							6{' '}
							<span className={isHighlighted ? 'text-primary ' : ''}>
								Such knowledge is too wonderful for me; i is high, I cannot attatin
								it.
							</span>
						</p>
						<p>
							7{' '}
							<span className={isHighlighted ? 'text-primary ' : ''}>
								Where can I go from Your Spirit? Or wherecan I flee from Your pr
								esence?
							</span>
						</p>
						<p>
							8{' '}
							<span className={isHighlighted ? 'text-primary ' : ''}>
								If I ascend into heaven, You are there; i I make my bed in hell,f
						...
						<p>
							9{' '}
							<span className={isHighlighted ? 'text-primary ' : ''}>
								If I take the wings of the morning, and dell in the uttermost pawrts
								of the sea,
							</span>
						</p>
						<p>
							...
							<span className={isHighlighted ? 'text-primary ' : ''}>
								{' '}
								even there Your hand shall lead me, and our right hand shall hoYld
								me.
							</span>
						</p>
						<p>
						...
						<p>
							17 How precious also are Your thoughts to me, O God! How great is the
							sum of them!
						</p>
						<p>
						...
						<p>
							20 For they speak against You wickedly; Your enemies take Your name in
							vain.
						</p>
						<p>
							21 Do I not hate them, O Lord, who hate You? And do I not loathe those
					...
					>
						...
						<p>
							2 Deliver me, O Lord, from the evil man; preserve me from the violent
							man,
						</p>
						<p>
							3 who devises evil things in their hearts; continually they gather
							together for war.
						</p>
						<p>
							4 They sharpen their tongues like a serpent; the poison of asps is under
							their lips. Selah
						</p>
						<p>
							5 Keep me, O Lord, from the hands of the wicked; preserve me from the
							violent man, who have purposed to make my steps stumble.
						</p>
						<p>
							6 The proud have hidden a snare for me, and cords; they have spread a
							net by the wayside; they have set traps for me. Selah
						</p>
						<p>
							7 I said to the Lord, “You are my God; hear the voice of my
							supplications, O Lord.”
						</p>
						<p>
							8 O Lord God, the strength of my salvation, You have covered my head in
							the day of battle.
						</p>
						<p>
							9 Do not grant, O Lord, the desires of the wicked; do not further their
							wicked schemes, lest they be exalted. Selah
						</p>
						<p>
							10 As for the head of those who surround me, let the mischief of their
							own lips cover them;
						</p>
						<p>
							11 let burning coals fall on them; let them be cast into the fire, into
							deep pits, that they rise not up again.
						</p>
						<p>
							12 Let not a slanderer be established in the earth; let evil hunt the
							violent man to overthrow him.
						</p>
						<p>
							13 I know that the Lord will maintain the cause of the afflicted, and
							justice for the poor.
						</p>
						<p>
							14 Surely the righteous shall give thanks to Your name; the upright
