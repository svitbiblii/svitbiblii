...
Now, this principle is in full operation still, and ought to be <span id="solemnly" className="text-blue-500">solemnly</span> pondered by the young. Self-indulgence, the sowing of wild oats, the seeing of life while one is young, the taking one’s fling before one settles down, the having one’s day (like “every dog,” for it is to be observed that no person says, “every Christian”), these things seem natural enough. And their unsuspected issues in the next generation, dire and subtle and far-reaching, these also are more natural still, being the operation of the laws of God.
