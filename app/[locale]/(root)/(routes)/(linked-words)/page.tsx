...
export default function LinkedWorldsPage() {
    ...
    return (
        ...
        className=" mt-6 py-8 px-4 lg:pb-48 w-full overflow-y-auto">
            ...
            <Link href='/library/chadwick/#imperfectly' className="mr-2 text-blue-500">imperfectly</Link>
                <span>in the book A Brief Commentary on the Apocalypse by Sylvester Bliss</span>
                <button onClick={() => setExpanded(curr => !curr)}
                            className="ml-5">
                        {expanded ? <ChevronUp/> : <ChevronDown/>}
                    </button>
                    <p className={`hidden  text-gray-700                   ${
