...
<div className="relative ">
                    <button
                        onClick={toggleMenu}
                        className={`absolute top-24 z-20 ${isMenuOpen ? "left-8" : "left-60"}`}>
                ...
                <div className="hidden md:block">
                    <div
                        className={`content ${isMenuOpen ? "hidden" : "block"} h-screen mt-16 w-72 min-w-72 overflow-y-auto bg-white dark:bg-secondary pb-12 shadow-lg`}>
                        <div>
                            <About/>
