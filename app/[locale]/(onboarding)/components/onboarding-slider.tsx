	...
	return (
		<div className="flex items-center text-xl h-full lg:h-auto w-full lg:pb-12">
			...
			>
				<a
					href="/"
					className="lg:hidden absolute rounded-3xl z-20 w-[calc(100%-50px)] md:w-1/2 lg:w-5/6 left-0 md:left-1/4 lg:left-5 text-l text-center bottom-9 bg-white ml-6 md:ml-0 p-3 lg:p-2 text-black font-bold uppercase"
				>
					Почати...
				</a>
				<div className="min-w-full lg:min-w-[calc(33.33%-40px)] h-full lg:h-auto relative lg:mx-4">
					...
					<div className="lg:hidden absolute top-0 left-0 z-20 text-white text-xl pl-6 md:pl-12 lg:pl-6 mt-10">
						Ласкаво просимо у Світ Бібліі
					</div>
					<div className="absolute z-20 max-w-full w-9/12 lg:w-full text-2xl md:text-4xl lg:text-2xl top-24 lg:top-0 left-0 pt-6 pl-6 md:pl-12 lg:pl-6 pr-10 text-white font-bold leading-normal uppercase">
						Використовуйте строку пошуку, щоб знайти цікаві теми або біблійні вірши.
					</div>
					<div className="absolute rounded-3xl z-20 w-[calc(100%-50px)] md:w-1/2 lg:w-5/6 left-0 md:left-1/4 lg:left-5 text-l text-center bottom-28 lg:bottom-9 bg-white bg-opacity-50 shadow ml-6 md:ml-0 p-3 lg:p-2 text-black font-bold uppercase">
						Пошук...
				...
				<div className="min-w-full lg:min-w-[calc(33.33%-40px)] h-full lg:h-auto relative lg:mx-4">
					...
					<div className="absolute z-20 max-w-full w-9/12 lg:w-full text-2xl md:text-4xl lg:text-2xl top-24 lg:top-0 left-0 pt-6 pl-6 md:pl-12 lg:pl-6 pr-10 text-white font-bold leading-normal uppercase">
						Читаєте статті, розумійтеся на текстах і контексті, розширюйте своє знання.
					</div>
					<div className="absolute rounded-3xl z-20 w-[calc(100%-50px)] md:w-1/2 lg:w-5/6 left-0 md:left-1/4 lg:left-5 text-l text-center bottom-28 lg:bottom-9 bg-white bg-opacity-50 shadow ml-6 md:ml-0 p-3 lg:p-2 text-black font-bold uppercase">
						Новий заповіт...
						<span className="inline-block w-5 ml-3.5 relative top-0.5">
				...
				<div className="min-w-full lg:min-w-[calc(33.33%-40px)] h-full lg:h-auto relative lg:mx-4">
					...
					<div className="absolute z-20 max-w-full w-9/12 lg:w-full text-2xl md:text-4xl lg:text-2xl top-24 lg:top-0 left-0 pt-6 pl-6 md:pl-12 lg:pl-6 pr-10 text-white font-bold leading-normal uppercase">
						Зберігайте улюблені матеріали, щоб повернутися до них пізніше.
					</div>
					<div className="absolute rounded-3xl z-20 w-[calc(100%-50px)] md:w-1/2 lg:w-5/6 left-0 md:left-1/4 lg:left-5 text-l text-center bottom-28 lg:bottom-9 bg-white bg-opacity-50 shadow ml-6 md:ml-0 p-3 lg:p-2 text-black font-bold uppercase">
						Зберегти
						<span className="inline-block w-5 ml-3.5 relative top-0.5">
