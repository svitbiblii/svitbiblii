        ...
        <div className="flex items-center text-xl h-full lg:h-auto w-full">
            ...
            >
                ...
                <div className="min-w-full lg:min-w-[calc(33.33%-40px)] h-full lg:h-auto relative lg:mx-4">
                    ...
                    <div
                        className="absolute z-20 max-w-full w-9/12 lg:w-full text-3xl md:text-4xl lg:text-2xl top-24 lg:top-0 left-0 pt-6 pl-6 md:pl-12 lg:pl-6 pr-10 text-white font-bold leading-normal uppercase">Используйте
                        строку поиска, чтобы найти интересующие вас темы или библейские стихи.
                    </div>
                    <div
                        className="absolute rounded-3xl z-20 w-[calc(100%-50px)] md:w-1/2 lg:w-5/6 left-0 md:left-1/4 lg:left-5 text-l text-center bottom-5 bg-white ml-6 md:ml-0 p-4 lg:p-2 text-black font-bold uppercase">Пошук...<span
                ...
                <div className="min-w-full lg:min-w-[calc(33.33%-40px)] h-full lg:h-auto relative lg:mx-4">
                    ...
                    <div
                        className="absolute z-20 max-w-full w-9/12 lg:w-full text-3xl md:text-4xl lg:text-2xl top-24 lg:top-0 left-0 pt-6 pl-6 md:pl-12 lg:pl-6 pr-10 text-white font-bold leading-normal uppercase">Читаете
                        статьи, разбирайтесь в текстах и контексте, расширяйте своё знание.
                    </div>
                    <div
                        className="absolute rounded-3xl z-20 w-[calc(100%-50px)] md:w-1/2 lg:w-5/6 left-0 md:left-1/4 lg:left-5 text-l text-center bottom-5 bg-white ml-6 md:ml-0 p-4 lg:p-2 text-black font-bold uppercase">Новий
                ...
                <div className="min-w-full lg:min-w-[calc(33.33%-40px)] h-full lg:h-auto relative lg:mx-4">
                    ...
                    <div
                        className="absolute z-20 max-w-full w-9/12 lg:w-full text-3xl md:text-4xl lg:text-2xl top-24 lg:top-0 left-0 pt-6 pl-6 md:pl-12 lg:pl-6 pr-10 text-white font-bold leading-normal uppercase">Сохраняйте
                        любимые материалы, чтобы вернуться к ним позже.
                    </div>
                    <div
                        className="absolute rounded-3xl z-20 w-[calc(100%-50px)] md:w-1/2 lg:w-5/6 left-0 md:left-1/4 lg:left-5 text-l text-center bottom-5 bg-white ml-6 md:ml-0 p-4 lg:p-2 text-black font-bold uppercase">Зберегти<span
                        className="inline-block w-5 ml-3.5 relative top-0.5"><svg
                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path
