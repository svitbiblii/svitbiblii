        ...
        <div className="flex items-center text-xl h-full lg:h-auto w-full">
            ...
            >
                ...
                <div className="min-w-full lg:min-w-[calc(33.33%-40px)] h-full lg:h-auto relative lg:mx-4">
                    ...
                    <div
                        className="absolute rounded-3xl z-20 w-[calc(100%-50px)] md:w-1/2 lg:w-5/6 left-0 md:left-1/4 lg:left-5 text-l text-center bottom-28 bg-white bg-opacity-50 border ml-6 md:ml-0 p-3 lg:p-2 text-black font-bold uppercase">Пошук...<span
                ...
                <div className="min-w-full lg:min-w-[calc(33.33%-40px)] h-full lg:h-auto relative lg:mx-4">
                    ...
                    <div
                        className="absolute rounded-3xl z-20 w-[calc(100%-50px)] md:w-1/2 lg:w-5/6 left-0 md:left-1/4 lg:left-5 text-l text-center bottom-28 bg-white bg-opacity-50 border ml-6 md:ml-0 p-3 lg:p-2 text-black font-bold uppercase">Новий
                ...
                <div className="min-w-full lg:min-w-[calc(33.33%-40px)] h-full lg:h-auto relative lg:mx-4">
                    ...
                    <div
                        className="absolute rounded-3xl z-20 w-[calc(100%-50px)] md:w-1/2 lg:w-5/6 left-0 md:left-1/4 lg:left-5 text-l text-center bottom-28 bg-white bg-opacity-50 border ml-6 md:ml-0 p-3 lg:p-2 text-black font-bold uppercase">Зберегти<span
                        className="inline-block w-5 ml-3.5 relative top-0.5"><svg
                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path
