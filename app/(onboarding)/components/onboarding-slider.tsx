...
export const OnboardingSlider = () => {
    ...
    return (
        <div className="flex items-center text-xl h-full lg:h-auto w-full">
            ...
            >
                <div className="min-w-full lg:min-w-[calc(33.33%-20px)] h-full lg:h-auto relative mx-4">
                    <img
                    ...
                    <div className="lg:hidden absolute top-0 left-0 z-20 text-white text-xl pl-6 mt-10">Ласкаво просимо у
                        Світ Бібліі
                    </div>
                    <div
                        className="absolute z-20 max-w-full text-4xl top-24 lg:top-0 left-0 pt-6 pl-6 pr-10 text-white font-bold uppercase">Используйте
                        строку поиска, чтобы найти интересующие вас темы или библейские стихи.
                    </div>
                    <div
                        className="absolute rounded-3xl z-20 w-5/6 max-w-full text-l text-center bottom-5 bg-white left-5 p-2 text-black font-bold uppercase">Пошук...<span
                ...
                <div className="min-w-full lg:min-w-[calc(33.33%-20px)] h-full lg:h-auto relative mx-4">
                    ...
                    <div
                        className="absolute rounded-3xl z-20 w-5/6 max-w-full text-l text-center bottom-5 bg-white left-5 p-2 text-black font-bold uppercase">Новий
                ...
                <div className="min-w-full lg:min-w-[calc(33.33%-20px)] h-full lg:h-auto relative mx-4">
                    ...
                    <div
                        className="absolute rounded-3xl z-20 w-5/6 max-w-full text-l text-center bottom-5 bg-white left-5 p-2 text-black font-bold uppercase">Зберегти<span
                        className="inline-block w-5 ml-3.5 relative top-0.5"><svg
                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path
