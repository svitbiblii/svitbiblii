...
export const BOOKS_DATA: IBooks[] = [
	...
	},
	{
		...
		anotation:
			'Злата заприсяглась упродовж семи років приходити за ніч до Різдва до Яна — брата-близнюка свого зниклого чоловіка. І бути з ним до ранку в його замку у горах. Ян — геніальний органіст, але його музика — лиха. Коли він грає, каміння падає з башт церков, стіни тріскаються і блискавки влучають у вежі. Цією музикою кричить Адам, вигнанець із Раю. Події розгортаються в уявні часи, культурно близькі першій половині ХХ ст. Оповідь алегорична, сплетена з казкових, біблійних і міфологічних образів та мотивів.',
		genre: 'fiction',
		type: 'text',
		kategory: 'fiction',
